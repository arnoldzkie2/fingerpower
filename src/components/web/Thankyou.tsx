...
const Thankyou = () => {
    ...
    return (
        <section className='text-center py-10 lg:py-20 xl:py-36 px-5 sm:px-10 md:px-16 lg:px-24 xl:px-36 2xl:px-44 flex flex-col items-center text-gray-700 gap-10'>
